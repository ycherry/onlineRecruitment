...
<form name="form"method="post"action="reginfo.jsp">
   <table width="700" border="0"align="center"cellpadding="0" cellspacing="0"bgcolor="#F5f7f7">
   
   <tr align="center">
   <td height="27"colspan="2"><div id="reg"><font color=red>
   求职者修改信息</font></div></td>
   </tr>
<tr>
<td width="200"height="22"align="center">真实姓名:</td>
<td width="300">
<input type="text"name="struename"value="<%=rs.getString(3) %>">
</td>
</tr>
<tr>
<td width="200"height="22"align="center">年&nbsp;&nbsp;&nbsp;&nbsp;龄:</td>
<td width="300">
<input type="text"name="age"value="<%=rs.getInt(4) %>">
</td>
</tr>
<%int i=rs.getInt(5);
if(i==1){
...
<td width="300">
<input type="text"name="birthday"value="<%=rs.getString(6) %>">
年-月-日</td>
</tr>
<tr>
<td width="200"height="22"align="center">毕业院校:</td>
<td width="300">
<input type="text"name="school"value="<%=rs.getString(7) %>">
</td>
</tr>
<tr>
<td width="200"height="22"align="center">电子邮件:</td>
<td width="300">
<input type="text"name="emal"value="<%=rs.getString(10) %>">
</td>
</tr>
<tr>
<td width="200"height="22"align="center">所学专业:</td>
<td width="300">
<input type="text"name="specialty"value="<%=rs.getString(8) %>">
</td>
</tr>
<tr>
<td width="200"height="22"align="center">最高学历:</td>
<td width="300">
<input type="text"name="knowledge"value="<%=rs.getString(9) %>">
</td>
</tr>
<tr>
<td width="200"height="22"align="center">个人简历:</td>
<td width="300">
<textarea name="resume"cols="35"rows="5"><%=rs.getString(11) %></textarea>
</tr>
<tr align="center">
