...
/*			String sql = "UPDATE t_company SET ctrueName=" + "'"
					+ str.toGb(company.getCtruename()) + "'"
					+ ",email=" + "'" + str.toGb(company.getEmail())
					+ "'" + ",tel=" + "'" + str.toGb(company.getTel())
					+ "'" + ",manage=" + "'"
					+ str.toGb(company.getManage()) + "'" + ",address="
					+ "'" + str.toGb(company.getAddress()) + "'"
					+ ",resume=" + "'" + str.toGb(company.getResume())
					+ "'" + " WHERE cuserName=" + "'" + cuserName + "'";
*/
			String sql = "UPDATE t_company SET ctrueName=" + "'"
					+ company.getCtruename() + "'"
					+ ",email=" + "'" + company.getEmail()
					+ "'" + ",tel=" + "'" + company.getTel()
					+ "'" + ",manage=" + "'"
					+ company.getManage() + "'" + ",address="
					+ "'" + company.getAddress() + "'"
					+ ",resume=" + "'" + company.getResume()
					+ "'" + " WHERE cuserName=" + "'" + cuserName + "'";
			st.addBatch(sql);
