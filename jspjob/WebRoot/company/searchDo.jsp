...
<body>
	...
	<table width="680" border="1" cellspacing="0" cellpadding="0">
		...
		<tr>
			<td align="center" class="STYLE3"><%=rs.getString(3)%></td>
			<td align="center" class="STYLE3"><%=rs.getString(4)%></td>
			<td align="center" class="STYLE3"><%=rs.getString(5)%></td>
			<td align="center" class="STYLE3"><%=rs.getString(6)%></td>
		</tr>
		<%
			}
		%>
		<tr>
			<td colspan="4" align="right"><span class="STYLE8">总第<span
					class="STYLE4"><%=i%></span>/<span class="STYLE4">1</span>页 上一页
					下一页 尾页
			</span></td>
		</tr>
	</table>
