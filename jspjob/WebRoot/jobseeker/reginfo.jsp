...
String sql="UPDATE t_jobseeker SET trueName="+"'"+str.toGb(jobseeker.getStruename())+"'"+",age="+"'"+jobseeker.getAge()+"'"+",sex="+"'"+jobseeker.getSex()+"'"+",birthday="+"'"+str.toGb(jobseeker.getBirthday())+"'"+",school="+"'"+str.toGb(jobseeker.getSchool())+"'"+",specialty="+"'"+str.toGb(jobseeker.getSpecialty())+"'"+",knowledge="+"'"+str.toGb(jobseeker.getKnowledge())+"'"+",email="+"'"+str.toGb(jobseeker.getEmail())+"'"+",resume="+"'"+str.toGb(jobseeker.getResume())+"'"
+"WHERE auserName="+"'"+SuserName+"'";
st.addBatch(sql);
st.executeBatch();
