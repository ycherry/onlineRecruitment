...
<tr>
<td align="left"valing="top"><table width="600" border="0" align="left" cellpadding="0"
cellspacing="0" bgcolor="#F5f7f7">
<from name="from1" method="post" action="sendMail.jsp">
<tr align="center">
<td height="27" colspan="2"><div id="reg"><font color=red>发送邮件</font></div></td>
</tr>
<tr>
<td width="200" height="22" align="center">smtp服务器(和发送人邮件地址对应):</td>
<td width="300"><input type="text" name="smtpserver">*例如:smtp.sohu.com</td>
</tr>
<tr>
<td width="200" height="22" align="center">发件人信箱:</td>
<td width="300"><input type="text" name="from">*mmm@sss.com</td>
</tr>
<tr>
<td width="200" height="22" ahign="center">发件人信箱密码:</td>
<td width="300"><input type="password" name="pass"></td>
</tr>
<tr>
<td width="200" height="22" ahign="center">收件人1:</td>
<td width="300"><input type="text" name="from">*mmm@sss.com</td>
 </tr>
<tr>
...
<td height="22"><input name="aubject" type="text" size="35"></td>
</tr>
<tr>
