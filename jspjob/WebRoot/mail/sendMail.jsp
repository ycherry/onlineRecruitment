...
//	String strMailserver = "mail.sohu.com";
	...
	System.out.println("strSubject:"+strSubject+" strMessage:"+strMessage+" attachFile:"+attachFile+" smtpserver:"+smtpserver);
			...
			if (!arrstrTo[intI].equals("")) {
				try {
					String mailbody = "<meta http-equiv=Content-Type content=text/html;charset = UTF-8>"
							...
							+ strMessage
							+ "</div>";
					Mail themail = new Mail(smtpserver);
